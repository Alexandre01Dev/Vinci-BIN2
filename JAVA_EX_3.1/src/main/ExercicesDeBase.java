...
public class ExercicesDeBase {
    ...
    private final Transaction MAX_TRANSACTION = new Transaction(new Trader("",""),0,Integer.MAX_VALUE);
    ...
    private void predicats2() {
        ...
        var s = transactions
                .stream()
                .filter(transaction -> transaction.getValue() > 600);
    ...
    private void predicats3() {
        ...
        var s = transactions
                .stream()
                .filter(transaction -> transaction.getTrader().getName().equals("Raoul"));// TODO filtrer
    ...
    private void map0() {
        ...
        Stream<Trader> s = transactions.stream()
    ...
    private void map1() {
        ...
        Stream<String> s = transactions.stream()
    ...
    private void reduce2() {
        ...
        /*Transaction min = transactions.stream()
                .reduce(MAX_TRANSACTION, (i0, i1) -> {
                    if(i1.getValue() < i0.getValue())
                        return i1;
                    else
                        return i0;
                });*/
        ...
        Optional<Transaction> minTransaction = transactions.stream()
                .reduce((i0, i1) -> i1.getValue() < i0.getValue() ? i1 : i0);

        minTransaction.ifPresentOrElse(System.out::println,() -> {
