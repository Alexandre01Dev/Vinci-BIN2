...
public class ExerciceGroupingBy {
    ...
    private void groupBy1() {
        ...
        Map<Trader,List<Transaction>> t = transactions.stream()
    ...
    private void groupBy2() {
        ...
        Map<Trader, Long> t = transactions.stream()
                .collect(
    ...
    private void groupBy3() {
        ...
        Map<TransactionsLevel,List<Transaction>> t;
        ...
        t = transactions.stream()
                .collect(Collectors.groupingBy(transaction -> {
                    ...
                    if(transaction.getValue() <= 800){
                        return TransactionsLevel.HI;
                    }
                    if(transaction.getValue() <= 600){
