...
public class CompteurRunnableWithRaceCondition extends Compteur implements Runnable {
    ...
    public void count() {
        ...
        System.out.println(nom + " a finit de compter jusqu'à " + max + " en position " + ordreArrivee.incrementAndGet() + " à " + LocalDateTime.now());
        //  Bolt a fini de compter jusqu’à 10 et a terminé en position 3
    }
}
