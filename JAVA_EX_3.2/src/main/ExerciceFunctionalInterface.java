...
public class ExerciceFunctionalInterface {
    ...
    public static void main(String[] args) {
        ...
        Stream<Employe> listDesHommes = employes .stream() .filter(e -> e.getGenre() == Genre.HOMME);
    ...
    private static void exMap() {
        ...
        EmployeMap employeMap = new EmployeMap() {
            @Override
    ...
    private static void exForEach(){
        EmployeForEach employeForEach = System.out::println;
        employes.forEach(employeForEach);
    }
}
